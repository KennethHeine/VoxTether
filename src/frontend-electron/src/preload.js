 ...
 *
 * All IPC channel names are imported from shared/constants.js to ensure
 * consistency with the main process handlers in ipc-handlers.js.
 */

const { contextBridge, ipcRenderer } = require('electron');
const {
    // IPC Invoke/Handle channels
    IPC_GET_SETTINGS,
    IPC_SAVE_SETTINGS,
    IPC_BACKEND_HEALTH,
    IPC_GET_DEVICES,
